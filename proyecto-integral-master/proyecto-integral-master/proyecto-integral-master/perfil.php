      ...
      <div id="middletitle" class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <a class="mis-conactos" href="./mis-contactos.php"><button type="button" class="btn btn-sm btn-outline-secondary">My friends</button></a>
            <a class="mis-contactos" href="./vistapost.php"><button type="button" class="btn btn-sm btn-outline-secondary">My posts</button></a>
          </div>
