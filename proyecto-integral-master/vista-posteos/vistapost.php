<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/vistapost.css">
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="../perfil/perfil.php">Profile</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="../faqs/faqs.php">F.A.Q.S</a>
            </li>
          </ul>
    ...
    <main role="main">
          ...
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption">
                <h1>Movie2</h1>
                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                <p><a class="btn btn-lg btn-primary" href="#" role="button">One of the best movies of the year!</a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption text-right">
                <h1>Movie3</h1>
                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                <p><a class="btn btn-lg btn-primary" href="#" role="button">A classic one</a></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container-marketing">
        ...
        <h1 id="yourfilms">Reviews from people you follow</h1>
        <div class="row">
          <div class="col-lg-4">
